...
// ============================================================
// FORGOT USERNAME — shows accounts registered on this device
// ============================================================
function showForgotUsername() {
    ...
    const userRows = users.map(u => `
      <div class="fu-user-row">
        ...
        <div class="fu-info">
          ...
          <div class="fu-date">Registered ${u.createdAt ? new Date(u.createdAt).toLocaleDateString('en-IN', { day:'2-digit', month:'short', year:'numeric' }) : 'unknown date'}</div>
        </div>
      ...
      <div class="modal-sheet">
        ...
        <div class="modal-body">
          <p class="auth-subtitle" style="margin-bottom:16px">
            These accounts are registered in this browser. Tap <strong>Use</strong> to fill in your username.
          </p>
  ...
  // "Use" button — fills username field and closes modal
  el.querySelectorAll('.fu-use-btn').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      el.remove();
      showToast(`Username filled: @${uname}`);
    });
  });
}
